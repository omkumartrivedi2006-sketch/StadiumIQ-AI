        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-8 animate-slide-in-up p-6 bg-card rounded-lg border border-indigo-200 dark:border-indigo-800">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-semibold text-foreground">AI Transit Assistant</h2>
            </div>
          ...
          {loading ? (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {[1, 2, 3].map((i) => (
                <div key={i} className="p-6 bg-card rounded-lg border border-border space-y-4">
          ...
          <div className="animate-slide-in-up p-8 bg-card rounded-lg border border-border mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-4 bg-muted rounded-lg border border-border">
                <h3 className="font-semibold text-foreground mb-2">Peak Hours</h3>
          ...
          {/* Nearby Stations */}
          <div className="animate-slide-in-up p-8 bg-gradient-to-r from-indigo-50/50 to-cyan-50/50 dark:from-indigo-950/30 dark:to-cyan-950/30 rounded-lg border border-indigo-200 dark:border-indigo-800">
            <h2 className="text-2xl font-bold text-foreground mb-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={idx}
                  className="p-4 bg-card rounded-lg border border-indigo-200 dark:border-indigo-800"
                >
                  <h3 className="font-semibold text-foreground mb-2">
                    {station.name}
                  </h3>
